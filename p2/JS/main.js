...
function enterKey(e) {
  ...
  if (e.keyCode == 13) {
    ...
    git = commands.length;
    addLine("yassir@boualiyassir.github.io:~$ " + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    // languages
    case "java":
      loopLines(java, "color2 margin", 80);
    break;
    case "html" || "rails":
      loopLines(html, "color2 margin", 80);
    break;
    case "figma":
      loopLines(figma, "color2 margin", 80);
    break;
    // case "unity":
