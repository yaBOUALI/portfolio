let github = "https://github.com/yaBOUALI";
let linkedIn = "https://www.linkedin.com/in/yassir-bouali";

about = [
  "<br>",
  "Hi, I'm Yassir Bouali , an aspiring web developer with a passion for",
  "front-end development and back-end. I have experience working with Python and Java, and have used many",
...
social = [
  ...
  'github         <a href="' +
    github +
    '" target="_blank">github/yaBOUALI' +
    "</a>",
  'linkedin       <a href="' +
    linkedIn +
    '" target="_blank">linkedIn.com/yassir-bouali' +
    "</a>",
  'email          <a href="mailto:yassir@boua.li" target="_blank">email/yassir-bouali' +
    "</a>",
...
java = [
  ...
  "java projects<br>",
  "<br>",
  '<a href="https://github.com/yaBOUALI/email_colab" target="_blank">java Email collab' +
    "</a>",
...
html = [
  ...
  "html projects",
  "<br>",
  '<a href="https://github.com/yaBOUALI/simple-websit" target="_blank">rock paper scissors' +
    "</a>",
...
figma = [
  ...
  "figma projects",
  "<br>",
  '<a href="../Profile-2.pdf" target="_blank">simple design' +
    "</a>",
...
//   "React projects",
//   "<br>",
//   project("Learnify", "https://lap3-learnify.netlify.app/", "", "", "https://github.com/MisterCxmpy/Learnify"),
...
//   project("WIthin Agency", "https://withinagency.com", "", ""),
//   "<br>",
// ];
